...
**[This poject was built to implement a Ruby on Rails back-end.
Understand the pros and cons of different approaches of connecting Ruby on Rails back-end and cross origin.]** is a...
...
## 🚀 Link to React Frontend App <a name="live-demo">https://github.com/OyePriscilla/hello-react-frontend</a>
...
Enter this url: https://github.com/OyePriscilla/hello-rails-backend in your web browser.
...
```bash
$ git clone https://github.com/OyePriscilla/hello-rails-backend
```
--->
